...
namespace GoElectrify.DAL.Migrations
{
    ...
    [Migration("20251112193756_FixConsumed")]
    partial class FixConsumed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GoElectrify.BLL.Entities.Booking", b =>
                {
                    ...
                    b.HasIndex("ChargerId", "ScheduledStart")
                        .IsUnique()
                        .HasDatabaseName("ix_bookings_charger_id_scheduled_start")
                    ...
                    b.ToTable("ChargingSessions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_charging_sessions_status_allowed", "status in ('PENDING','RUNNING','COMPLETED','TIMEOUT','FAILED','ABORTED','UNPAID','PAID')");

                            t.HasCheckConstraint("ck_charging_sessions_status_flow", "CASE WHEN ended_at IS NULL THEN status IN ('PENDING','RUNNING') ELSE status IN ('COMPLETED','TIMEOUT','FAILED','ABORTED','UNPAID','PAID') END");
